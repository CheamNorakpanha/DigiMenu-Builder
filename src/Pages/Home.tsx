...
export default function LandingPage() {
    ...
    return (
        <div className={`flex flex-col min-h-screen ${darkMode ? 'dark' : ''}`}>
            <header className="px-40 h-16 flex items-center border-b border-gray-200 dark:border-[#d3a1d9] bg-white dark:bg-black transition-colors duration-200">
                <Link className="flex items-center justify-center" to="#">
                    {/* A logo */}
                    <span className="ml-2 text-xl font-bold text-[#764ab3] dark:text-[#764ab3]">DigiMenu Builder</span>
                </Link>
                <nav className="ml-auto flex items-center gap-4 sm:gap-6">
                    <Link className="text-base font-medium text-gray-700 hover:text-[#71389d] dark:text-gray-200 dark:hover:text-[#71389d]" to="#how-it-works">
                        How It Works
                    </Link>
                    <Link className="text font-medium text-gray-700 hover:text-[#71389d] dark:text-gray-200 dark:hover:text-[#71389d]" to="#features">
                        Features
                    </Link>
                    <Link className="text-base font-medium text-gray-700 hover:text-[#71389d] dark:text-gray-200 dark:hover:text-[#71389d]" to="#pricing">
                        Pricing
                    </Link>
                    <Link className="text-base font-medium text-gray-700 hover:text-[#71389d] dark:text-gray-200 dark:hover:text-[#71389d]" to="#contact">
                        Contact
                    </Link>
                        ...
                        <div className="flex flex-col items-center space-y-6 text-center">
                            <div className="space-y-2">
                                <h1 className="text-7xl font-bold tracking-tighter text-white dark:text-white pb-10">
                                    Welcome to <span className='text-[#3f238e] dark:text-[#d3a1d9]'>DigiMenu Builder</span>
                                </h1>
                ...
                <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-black transition-colors duration-200">
                    <div className="container px-4 md:px-6 mx-auto">
                        ...
                        <div className="flex justify-center">
                            <span className='border-t-2 border-[#71389d] dark:border-[#d3a1d9] mb-8'>&emsp;&emsp;&emsp;</span>
                        </div>
                        <div className="grid gap-6 lg:grid-cols-4">
                            {[
                                ...
                                <div key={index} className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg dark:bg-transparent transition-colors duration-200 border border-gray-400 dark:border-[#764ab3]">
                                    <step.icon className="w-12 h-12 mb-4 text-[#764ab3] dark:text-[#d3a1d9]" />
                ...
                <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800 transition-colors duration-200"
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        ...
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <button
                                className="inline-flex items-center justify-center rounded-md bg-[#71389d] dark:bg-[#4f276d] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#4f276d] dark:hover:bg-[#371b4c]"
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        ...
                        <div className="grid gap-8 lg:grid-cols-3">
                            {[
                                ...
                                <div key={index} className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-md dark:bg-transparent transition-colors duration-200 border border-gray-400 dark:border-[#764ab3]">
                                    <feature.icon className="w-12 h-12 mb-4 text-[#764ab3] dark:text-[#d3a1d9]" />
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        ...
                        <div className="grid gap-8 lg:grid-cols-3">
                            {[
                                ...
                                <div key={index} className="backdrop-blur-sm flex flex-col p-6 bg-gray-50 rounded-lg shadow-lg dark:bg-transparent transition-colors duration-200 border border-gray-400 dark:border-[#764ab3]">
                                    <plan.icon className="w-12 h-12 mb-4 text-[#764ab3] dark:text-[#d3a1d9]" />
                        ...
                        <div className="grid gap-8 lg:grid-cols-2">
                            <div>
                                <form className="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name" className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-900 dark:border-[#764ab3] dark:text-white" placeholder="Your name" />
                                    </div>
                                    <div>
                                        <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email</label>
                                        <input type="email" id="email" name="email" className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-900 dark:border-[#764ab3] dark:text-white" placeholder="you@example.com" />
                                    </div>
                                    <div>
                                        <label htmlFor="message" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Message</label>
                                        <textarea id="message" name="message" rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-900 dark:border-[#764ab3] dark:text-white" placeholder="Your message"></textarea>
                                    </div>
                                    <button type="submit" className="inline-flex items-center justify-center rounded-md bg-[#71389d] dark:bg-[#4f276d] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#4f276d] dark:hover:bg-[#371b4c] w-full">
                                        Send Message
                                    </button>
                                </form>
                            </div>
                            <div className="space-y-4 pt-5">
                                <div className="flex items-center space-x-2">
                                    <Mail className="w-6 h-6 text-[#71389d] dark:text-[#71389d]" />
                                    <span className="text-gray-600 dark:text-gray-300">contact@digimenubuilder.com</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Phone className="w-6 h-6 text-[#71389d] dark:text-[#71389d]" />
                                    <span className="text-gray-600 dark:text-gray-300">+1 (555) 123-4567</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <MapPin className="w-6 h-6 text-[#71389d] dark:text-[#71389d]" />
            ...
            <footer className="w-full bg-gray-100 dark:bg-black text-white transition-colors duration-200">
                <div className="border-t border-gray-300 dark:border-[#764ab3] py-4 text-center">
                    <p className="text-sm text-gray-500 dark:text-[#764ab3]">© 2024 DigiMenu Builder. All rights reserved.</p>
                </div>
            </footer>
        </div>
    )
